...
import rmm.ninjaone.catalog.domain.models.devices.subscriptions.TieredSubscription;
...
public class DeviceTieredSubscriptionConverterStrategy implements SubscriptionConverterStrategy<TieredSubscription> {
